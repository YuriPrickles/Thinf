...
{
	public class PixieLeaf : ModProjectile
	{

		public override void SetStaticDefaults()
		{
			ProjectileID.Sets.Homing[projectile.type] = true;
		DisplayName.SetDefault("Pixie Leaf");     //The English name of the projectile
		...
		public override void SetDefaults()
		{
			...
			projectile.light = 1.3f;            //How much light emit around the projectile
