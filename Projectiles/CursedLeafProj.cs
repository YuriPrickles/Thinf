...
{
	public class CursedLeafProj : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Cursed Flame Leaf");     //The English name of the projectile
		}
        ...
        public override void Kill(int timeLeft)
		{
			...
			int projectileSpawnAmount = 5;
			for (int i = 0; i < projectileSpawnAmount; ++i)
			{
				float currentRotation = (MathHelper.TwoPi / projectileSpawnAmount) * i;
				Vector2 projectileVelocity = currentRotation.ToRotationVector2().RotatedByRandom(7) * 12f;
				Projectile proj = Main.projectile[Projectile.NewProjectile(projectile.Center, projectileVelocity, ProjectileID.CursedFlameFriendly, projectile.damage, 0, projectile.owner)];
				proj.ranged = false;
				proj.melee = false;
				proj.magic = false;
				proj.minion = false;
