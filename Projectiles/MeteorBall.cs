...
namespace Thinf.Projectiles
{
	public class MeteorBall : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("Meteor Ball");     //The English name of the projectile
		...
		public override void AI()
		{
			...
			if (target)
			{
				...
				projectile.velocity = (6 * projectile.velocity + move) / 16f;
				AdjustMagnitude(ref projectile.velocity);
			}
		}
		...
		public override void Kill(int timeLeft)
		{
			...
			{
				Dust dust;
				dust = Main.dust[Terraria.Dust.NewDust(projectile.position, 30, 30, 6, 0f, 0f, 0, new Color(255, 255, 255), 1f)];
				dust.noGravity = true;
				dust.fadeIn = 1f;
			}
