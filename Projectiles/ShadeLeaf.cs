...
{
	public class ShadeLeaf : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Blood Leaf");     //The English name of the projectile
		...
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
		{
			if (target.type != NPCID.TargetDummy)
			{
				...
				if (rand == 0)
				{
					target.AddBuff(BuffID.Bleeding, 420); //On Fire! debuff for 3 seconds
				}
				else if (rand == 1)
				{
