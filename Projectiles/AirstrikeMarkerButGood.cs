...
{
    public class AirstrikeMarkerButGood : ModProjectile
    {
        Vector2 rocketPos;
        ...
        public override void AI()
        {
            ...
            {
                Projectile airstrike = Projectile.NewProjectileDirect(rocketPos, new Vector2(0, 16), ProjectileID.RocketIII, projectile.damage, 40, Main.myPlayer);
