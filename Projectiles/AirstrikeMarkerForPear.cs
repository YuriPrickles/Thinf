...
{
    public class AirstrikeMarkerForPear : ModProjectile
    {
        Vector2 rocketPos;
        ...
        public override void AI()
        {
            ...
            {
                Projectile airstrike = Projectile.NewProjectileDirect(rocketPos, new Vector2(0, 16), ProjectileID.RocketIII, 30, 40, Main.myPlayer);
