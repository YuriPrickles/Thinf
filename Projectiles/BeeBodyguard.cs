    ...
    public class BeeBodyguard : Minion
    {
        ...
        public override void Behavior()
        {
            ...
            if (AiState == 2)
            {
                if (AttackCooldown <= 0)
                {
                    Projectile.NewProjectile(projectile.Center, projectile.DirectionTo(targetPositionForProj) * 5f, ProjectileID.BulletHighVelocity, projectile.damage, projectile.knockBack, projectile.owner);
