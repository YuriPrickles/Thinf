...
namespace Thinf.Projectiles
{
	public class CoolGuitarHeldProj : ModProjectile
	{
		...
		private static float AimResponsiveness = 0.15f;
		...
		private float MaxManaConsumptionDelay = 15f;
		private float MinManaConsumptionDelay = 5f;
		...
		{
			DisplayName.SetDefault("Cool Guitar");
		...
		public override void AI()
		{
            ...
            {
				MinManaConsumptionDelay = 20f;
				MaxManaConsumptionDelay = 40f;
				NumBeams = 4;
				AimResponsiveness = 0.75f;
				DamageStart = 10f;
				MaxCharge = 30f;
			}
			else
			{
				MinManaConsumptionDelay = 5f;
				MaxManaConsumptionDelay = 15f;
				NumBeams = 2;
				AimResponsiveness = 0.15f;
				DamageStart = 30f;
				MaxCharge = 90f;
			}
		...
		private void FireBeams()
		{
			...
			{
				Projectile.NewProjectile(projectile.Center, beamVelocity, ProjectileType<CoolGuitarBeam>(), damage, knockback, projectile.owner, b, uuid);
			}
