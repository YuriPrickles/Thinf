...
{
	public class BrightboltGood : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Brightbolt");     //The English name of the projectile
		...
		{
			Lighting.AddLight(projectile.Center, new Vector3(255, 255, 0) / 255f);
