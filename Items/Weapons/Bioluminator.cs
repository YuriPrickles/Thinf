...
{
	public class Bioluminator : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Wooden arrows turn into Brightbolts that bounce off of tiles");
		}
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
            ...
            {
				type = ModContent.ProjectileType<BrightboltGood>();
				speedX *= 2;
				speedY *= 2;
            }
			return true;
