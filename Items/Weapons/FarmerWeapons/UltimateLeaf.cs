...
{
	public class UltimateLeaf : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Throws leaf shooting leaves\nIt's infinite! Enjoy this leaf while you can, the next leaves will be consumable");
		}
		...
		public virtual void SafeSetDefaults()
		{
			...
			item.shoot = ProjectileType<UltimateLeafProj>();
			item.noMelee = true;
