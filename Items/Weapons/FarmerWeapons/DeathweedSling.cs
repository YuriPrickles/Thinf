...
{
	public class DeathweedSling : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Deathweed Slingshot");
			Tooltip.SetDefault("Shoots seeds with the power of [temporary epic description]");
		}
