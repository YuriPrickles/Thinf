...
{
	public class BananaBomber : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Throws Banana Peels\n'Banana!'");
		}
		...
		public virtual void SafeSetDefaults()
		{
			...
			item.shoot = ProjectileType<Banana>();
			item.noMelee = true;
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
			...
			Projectile.NewProjectile(position, speed / 2, ProjectileType<BananaPeel>(), damage / 2, knockBack, player.whoAmI);
			return true;
        }
