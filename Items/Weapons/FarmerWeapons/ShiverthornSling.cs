...
{
	public class ShiverthornSling : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Shiverthorn Slingshot");
			Tooltip.SetDefault("Shoots seeds with the power of cold");
		}
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ItemID.SnowBlock, 120);
