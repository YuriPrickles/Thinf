...
{
	public class BloodclotSling : ModItem
	{
		int numShot = 4;
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Bloodclot Slingshot");
			Tooltip.SetDefault("Shoots seeds with the power of blood");
		}
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			{
				Vector2 perturbedSpeed = new Vector2(speedX, speedY).RotatedByRandom(MathHelper.ToRadians(3 * numShot));
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ItemType<Bloodclot>(), 10);
