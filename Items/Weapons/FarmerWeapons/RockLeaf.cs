...
{
	public class RockLeaf : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Throws rock leaves that completely stop enemy velocity\nBosses have a 1/10 chance to be stopped\nThe good old days where we used to throw rocks at people");
		}
		...
		public virtual void SafeSetDefaults()
		{
			...
			item.shoot = ProjectileType<RockLeafProj>();
			item.noMelee = true;
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ItemType<Leaf>(), 50);
