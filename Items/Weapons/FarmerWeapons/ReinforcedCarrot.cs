...
{
	public class ReinforcedCarrot : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Throws quick damaging carrots\n'It's still edible, your stomach just gets pierced by the metal'");
		}
		...
		public virtual void SafeSetDefaults()
		{
			...
			item.shoot = ProjectileType<ReinforcedCarrotProj>();
			item.noMelee = true;
        ...
        public override void AddRecipes()
        {
			...
			recipe.AddIngredient(ItemType<Placeables.Carrot>(), 50);
