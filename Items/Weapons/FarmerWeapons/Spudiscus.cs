...
{
	public class Spudiscus : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Throws a potato disc that bounces and explodes\n'Would the plural be Spudiscuses or Spudiscii?'");
		}
		...
		public virtual void SafeSetDefaults()
		{
			...
			item.shoot = ProjectileType<SpudiscusProj>();
			item.noMelee = true;
