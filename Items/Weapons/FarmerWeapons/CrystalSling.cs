...
{
	public class CrystalSling : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Crystal Slingshot");
			Tooltip.SetDefault("Seeds become crystals in the hallow\nSuper accurate slingshot, sacrifices speed for mega damage!");
		}
		...
		public virtual void SafeSetDefaults()
		{
			...
			item.shoot = ProjectileType<NoGravSeed>();
			item.noMelee = true;
			item.shootSpeed = 32f;
			item.useTime = 40;
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ItemID.PearlstoneBlock, 300);
			recipe.AddIngredient(ItemID.PixieDust, 15);
			recipe.AddIngredient(ItemID.CrystalSofaHowDoesThatEvenWork, 5);
