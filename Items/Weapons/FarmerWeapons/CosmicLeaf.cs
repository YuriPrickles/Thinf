...
{
	public class CosmicLeaf : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Throws cosmic leaves that spew out stars\nleaf description thing here");
		}
		...
		public virtual void SafeSetDefaults()
		{
			...
			item.shoot = ProjectileType<CosmicLeafProj>();
			item.noMelee = true;
        ...
        public override void AddRecipes()
        {
			...
			recipe.AddIngredient(ItemType<Leaf>(), 250);
			recipe.AddIngredient(ItemType<CosmicHerbalPiece>(), 5);
