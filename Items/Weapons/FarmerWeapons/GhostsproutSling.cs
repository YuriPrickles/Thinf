...
{
	public class GhostsproutSling : ModItem
	{
		int numShot = 10;
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Ghost Sprout Slingshot");
			Tooltip.SetDefault("Shoots a spread of short ranged seeds that pierce multiple enemies and go through tiles");
		}
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ItemType<GhostSprout>(), 10);
