...
{
    public class Herbliterator : ModItem
    {
        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("A rapid-fire shotgun\nPlease don't eat this\nHas a 60% chance to not consume ammo");
        }
        ...
        {
            ModRecipe recipe = new ModRecipe(mod); recipe.AddIngredient(ItemID.SDMG); recipe.AddIngredient(ItemID.TacticalShotgun); recipe.AddIngredient(mod.ItemType("CactusGun")); recipe.AddIngredient(mod.ItemType("CosmicHerbalPiece"), 10); recipe.AddIngredient(ItemID.ChlorophyteBar, 20); recipe.AddTile(TileID.LunarCraftingStation); recipe.SetResult(this); recipe.AddRecipe();
        }
