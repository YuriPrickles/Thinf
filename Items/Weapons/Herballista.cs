...
{
    public class Herballista : ModItem
    {
        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("A powerful bow that summons extra arrows around you");
        }
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            for (int i = 0; i < projectileSpawnAmount; ++i)
            {
                ...
                Projectile projectile = Main.projectile[Projectile.NewProjectile(player.Center + projectileVelocity * 50f, Vector2.Zero, type, damage, 1, player.whoAmI)]; //code by eldrazi#2385
                projectile.noDropItem = true;
                projectile.velocity = projectile.DirectionTo(Main.MouseWorld) * item.shootSpeed;
            }
