...
{
    public class SquirrelShotgun : ModItem
    {
        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("Occasionally shoots acorns\nHas a 10% chance to not consume ammo\n'The squirrel is there for moral support'");
        }
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            for (int i = 0; i < numberProjectiles; i++)
            {
                ...
                Projectile.NewProjectileDirect(position, perturbedSpeed, type, damage, knockBack, player.whoAmI);
            }
            if (Main.rand.Next(5) == 0)
            {
                Projectile projectile = Projectile.NewProjectileDirect(position, new Vector2(speedX, speedY) * 0.7f, ModContent.ProjectileType<DeathAcorn>(), damage * 2, knockBack, player.whoAmI);
