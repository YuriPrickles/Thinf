...
{
	public class MeteorGun : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Shoots meteors\nUses rockets as ammo\nHas a 75% chance to not consume rockets");
		}
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			Projectile proj = Projectile.NewProjectileDirect(position, speed, ProjectileID.Meteor1, damage, knockBack, player.whoAmI);
			proj.alpha = 0;
			proj.hide = false;
			proj.magic = false;
			proj.ranged = true;
