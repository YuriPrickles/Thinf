...
namespace Thinf.Blocks
{
	...
	public class SpinachTile : ModTile
	{
		...
		public override void SetDefaults()
		{
			...
			TileObjectData.newTile.HookPostPlaceMyPlayer = new PlacementHook(ModContent.GetInstance<SpinachTileEntity>().Hook_AfterPlacement, -1, 0, true);
		...
		{
			ModContent.GetInstance<SpinachTileEntity>().Kill(i, j);
		}
