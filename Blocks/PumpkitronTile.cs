...
namespace Thinf.Blocks
{
	...
	public class PumpkitronTile : ModTile
	{
		...
		public override void SetDefaults()
		{
			...
			TileObjectData.newTile.HookPostPlaceMyPlayer = new PlacementHook(ModContent.GetInstance<PumpkitronTileEntity>().Hook_AfterPlacement, -1, 0, true);
		...
		{
			ModContent.GetInstance<PumpkitronTileEntity>().Kill(i, j);
		}
