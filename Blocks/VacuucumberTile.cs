...
namespace Thinf.Blocks
{
	...
	public class VacuucumberTile : ModTile
	{
		...
		public override void SetDefaults()
		{
			...
			TileObjectData.newTile.HookPostPlaceMyPlayer = new PlacementHook(ModContent.GetInstance<VacuucumberTileEntity>().Hook_AfterPlacement, -1, 0, true);
		...
		{
			ModContent.GetInstance<VacuucumberTileEntity>().Kill(i, j);
		}
		...
		public override bool Drop(int i, int j)
		{
			...
			if (stage == PlantStage.Grown)
				Item.NewItem(new Vector2(i, j).ToWorldCoordinates(), ItemID.SmokeBlock, Main.rand.Next(12) + 24);
