...
namespace Thinf.Blocks
{
	...
	public class WheatTile : ModTile
	{
		...
		public override bool Drop(int i, int j)
		{
			...
			{
				Item.NewItem(new Vector2(i, j).ToWorldCoordinates(), ModContent.ItemType<Wheat>(), Main.rand.Next(3) + 6);
				Item.NewItem(new Vector2(i, j).ToWorldCoordinates(), ModContent.ItemType<WheatSeeds>(), Main.rand.Next(2) + 4);
			}
