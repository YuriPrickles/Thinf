...
namespace Thinf.Blocks
{
	...
	public class SaplingTile : ModTile
	{
		...
		public override void SetDefaults()
		{
			...
			TileObjectData.newTile.HookPostPlaceMyPlayer = new PlacementHook(ModContent.GetInstance<SaplingTileEntity>().Hook_AfterPlacement, -1, 0, true);
