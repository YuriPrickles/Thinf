...
namespace Thinf.Blocks
{
	...
	public class TobaccapTile : ModTile
	{
		...
		public override void SetDefaults()
		{
			...
			TileObjectData.newTile.HookPostPlaceMyPlayer = new PlacementHook(ModContent.GetInstance<TobaccapTileEntity>().Hook_AfterPlacement, -1, 0, true);
		...
		{
			ModContent.GetInstance<TobaccapTileEntity>().Kill(i, j);
		}
