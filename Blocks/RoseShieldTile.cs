...
namespace Thinf.Blocks
{
	...
	public class RoseShieldTile : ModTile
	{
		...
		public override void SetDefaults()
		{
			...
			TileObjectData.newTile.HookPostPlaceMyPlayer = new PlacementHook(ModContent.GetInstance<RoseShieldTileEntity>().Hook_AfterPlacement, -1, 0, true);
		...
		{
			ModContent.GetInstance<RoseShieldTileEntity>().Kill(i, j);
		}
