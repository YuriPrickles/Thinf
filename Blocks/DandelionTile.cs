...
namespace Thinf.Blocks
{
	...
	public class DandelionTile : ModTile
	{
		...
		public override void SetDefaults()
		{
			...
			TileObjectData.newTile.HookPostPlaceMyPlayer = new PlacementHook(ModContent.GetInstance<DandelionTileEntity>().Hook_AfterPlacement, -1, 0, true);
		...
		{
			ModContent.GetInstance<DandelionTileEntity>().Kill(i, j);
		}
