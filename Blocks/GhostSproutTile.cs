...
namespace Thinf.Blocks
{
	...
	public class GhostSproutTile : ModTile
	{
		...
		public override bool Drop(int i, int j)
		{
			...
			{
				Item.NewItem(new Vector2(i, j).ToWorldCoordinates(), ModContent.ItemType<GhostSproutSeeds>(), Main.rand.Next(2, 4));
				Item.NewItem(new Vector2(i, j).ToWorldCoordinates(), ModContent.ItemType<GhostSprout>(), Main.rand.Next(2, 3));
			}
			return false;
		}
