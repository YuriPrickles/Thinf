            ...
            if (phaseCount == -1240)
            {
                ...
                switch(cutsceneTimer)
                {
                    ...
                    case 240:
                        ...
                        Main.combatText[CombatText.NewText(npc.getRect(), Color.CornflowerBlue, "It seems I'm going to die any second now")].lifeTime = 360;
                        break;
                    case 600:
                        Main.combatText[CombatText.NewText(npc.getRect(), Color.CornflowerBlue, "But before you kill me, I want you to remember...")].lifeTime = 420;
                        break;
                    case 1020:
                        if (willDieHorribly)
                        {
                        ...
                        Main.combatText[CombatText.NewText(npc.getRect(), Color.CornflowerBlue, "That if the combat here was turn-based...")].lifeTime = 360;
                        break;
                    case 1380:
                        Main.combatText[CombatText.NewText(npc.getRect(), Color.CornflowerBlue, "I would've... totally killed you... I think...")].lifeTime = 360;
                        break;
                    case 1800:
                    ...
                    case 2160:
                        ...
                        Main.combatText[CombatText.NewText(npc.getRect(), Color.CornflowerBlue, "Is your refrigerator running?")].lifeTime = 480;
                        break;
                }
                ...
                if (cutsceneTimer >= 2160)
                {
                    ...
                    if (npc.alpha == 265)
                    {
                        ...
                        if (willDieHorribly)
                        {
                            ...
                            Main.NewText("The snow feels snowier...", Color.LightBlue);
                        ...
                        else
                        {
                            ...
                            Main.NewText("The snow feels colder...", Color.LightBlue);
                            //if (Main.expertMode)
                            //{
                            //    Main.NewText("Nice", Color.SlateGray);
                            //}
                        }
                        Main.NewText("You should probably check your refrigerator...", Color.LightBlue);
