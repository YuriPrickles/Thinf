...
{
    public class BloodyPottedPlant : ModNPC
    {
        int frameCount = 0;
        ...
        {
            Projectile.NewProjectileDirect(npc.Center, Vector2.Zero, ModContent.ProjectileType<CrimeraLeafProj>(), (int)damage, 0, Player.FindClosest(npc.Center, 10000, 10000)).ai[0] = 120;
        }
