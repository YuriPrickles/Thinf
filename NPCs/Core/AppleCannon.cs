...
{
    public class AppleCannon : ModNPC
    {
        int seedSpitTimer = 0;
        ...
        public override void AI()
        {
            ...
            {
                Projectile.NewProjectileDirect(npc.Center, (Vector2.Normalize(player.Center - npc.Center) * 3).RotatedByRandom(MathHelper.ToRadians(15)), ModContent.ProjectileType<AppleRocket>(), 110, 10);
                seedSpitTimer = 0;
            }
            timeUntilNoShield++;
